...
def run_full_text(model_id, strat_name="chain_of_thought", temp=0.7):
    ...
    # Load data
    data = pd.read_csv("data/reason_set-full_status-label34_20260107.csv")
    ...
    json_data = batched_inference(data, model, tokenizer, prompt_fn, temp, batch_size=2)

    # Save predictions as JSON
    with open(f"output/reason_batch/{model_id}/prediction/{strat_name}_temp{temp}_predictions_20260107.json", 'w') as f:
        json.dump(json_data, f, indent=2)

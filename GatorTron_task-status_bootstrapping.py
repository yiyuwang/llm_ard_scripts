...
def get_model(params, df_test, n_classes=None):
    ...
    # best_state_path = f"output/status_batch/gatortron-base_finetune_status_20260106/best_model/best_model_state_tune-{params.get('tune_mode', 'full')}.bin"
...
def run_full_text(params, device):
    ...
    tdir = f"output/gatortron-base_finetune_status/bootstrap/"
